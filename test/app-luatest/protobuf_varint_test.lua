...
g.test_sint32_exception_cdata = function()
    ...
    local msg = 'Input data for "val" field is "-2147483650LL" ' ..
        'and do not fit in "sint32"'
...
g.test_int64_exception_poz = function()
    ...
    local msg = 'Input data for "val" field is "9.2333720368548e+18" ' ..
        'and do not fit in "int64"'
    local data = {val = 9233372036854775808}
    t.assert_error_msg_contains(msg, protocol.encode, protocol, 'test', data)
end
...
g.test_int64_exception_cdata = function()
    ...
    local msg = 'Input data for "val" field is "9233372036854775808ULL" ' ..
        'and do not fit in "int64"'
    local data = {val = 9233372036854775808ULL}
    t.assert_error_msg_contains(msg, protocol.encode, protocol, 'test', data)
end
...
g.test_uint64_positive = function()
    ...
    local result = protocol:encode('test', {val = 2147483500ULL})
