...
g.test_double_min_64 = function()
    ...
    local result = protocol:encode('test', {val = -1.7976931348623157E+308})
...
g.test_double_exception_size = function()
    local protocol = protobuf.protocol({
        protobuf.message('test', {val = {'double', 1}})
    })
    local msg = 'Input data for "val" field is "inf" and ' ..
        'do not fit in "double"'
    local data = {val = 1.7986931348623157E+308}
    t.assert_error_msg_contains(msg, protocol.encode, protocol, 'test', data)
end
...
g.test_sfixed64_exception_size = function()
   ...
   local msg = 'Input data for "val" field is "9.8233720368548e+18" ' ..
